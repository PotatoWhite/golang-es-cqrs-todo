...
type EntityStore interface {
	...
	ReplayEvents(events []*command.Event) (todo *spec.Todo, err error)
}
...
func (ets *entityStore) ReplayEvents(events []*command.Event) (todo *spec.Todo, err error) {
...
func (ets *entityStore) createTodo(event spec.TodoCreated) (todo *spec.Todo, err error) {
	return &spec.Todo{
		Id:        event.ID(),
		Title:     event.Title,
		UserNo:    event.UserNo,
